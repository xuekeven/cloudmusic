  ...
  <div>
    <el-row :gutter="20">
      ...
      <el-col :offset="2" :span="5">
        <!-- 榜单列表 -->
        <RankList @getToplistDet="getToplistDet" />
      </el-col>
      <!-- 右侧 -->
      <el-col :span="15">
        <!-- 榜单详情 -->
        <MySongShow :playListInfoAttr="toplist" :playListCommentsAttr='toplistComments' />
        <!-- 评论 -->
        <AlbumComent :albumComentsObj="toplistComments" />
        <!-- 分页 -->
        <div class="box">
          <el-pagination
